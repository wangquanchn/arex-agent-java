...
public class CachedBodyRequestWrapperV3 extends HttpServletRequestWrapper {
     ...
     */
    public CachedBodyRequestWrapperV3(HttpServletRequest request) {
        super(request);
    ...
    public CachedBodyRequestWrapperV3(HttpServletRequest request, boolean readRequest) {
        super(request);
        int contentLength = request.getContentLength();
        this.cachedContent = new ByteArrayOutputStream(contentLength >= 0 ? contentLength : 1024);
     ...
     * @since 4.3.6
     */
    public CachedBodyRequestWrapperV3(HttpServletRequest request, int contentCacheLimit) {
        super(request);
     ...
     *
     * @see #CachedBodyRequestWrapperV3(HttpServletRequest, int)
     */
    ...
    private static class ContentCachedInputStream extends ServletInputStream {
